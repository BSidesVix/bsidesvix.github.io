(function ($, window) {
    ...
    const AppHTML = {
        contentModal: function (options) {
            ...
            return `
                ...
                <div class="modal-dialog" role="document" style="max-width:${options.width}; height:${options.height} background-color:${options.cor};">
                    <div class="modal-content">
                    <div class="modal-header" style="border-bottom:0!important;">
                        <h5 class="modal-title" id="">${options.title}</h5>
                        <button type="button" class="fechar ${options.font}" data-dismiss="modal" aria-label="Close"></button>
                    </div>
    ...
    AppInit_.prototype.AppPlugins_.prototype.modal = function (options_) {
